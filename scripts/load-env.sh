...
set -euo pipefail
_ALLOWED_KEYS=' MODEL_DIR DRAFT_DIR CACHE_DIR GPU_DEVICES BIND_ADDRESS PORT UPSTREAM_PORT CONTAINER_NAME SERVED_MODEL_NAME RUNTIME_IMAGE MAX_MODEL_LEN MAX_NUM_BATCHED_TOKENS MAX_NUM_SEQS GPU_MEMORY_UTILIZATION KV_CACHE_DTYPE MAX_IMAGES_PER_PROMPT MAX_VIDEOS_PER_PROMPT ENABLE_PREFIX_CACHING DFLASH_TOKENS DFLASH_KV_CACHE_DTYPE ACCEPT_DFLASH2_RESEARCH_LICENSE ENABLE_EXPERT_PARALLEL DECODE_CONTEXT_PARALLEL_SIZE VLLM_DCP_TOPK_OWNER_MERGE VLLM_B12X_DCP_TOPK_OWNER_EXCHANGE NCCL_DEBUG '
